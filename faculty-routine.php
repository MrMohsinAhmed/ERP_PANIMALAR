        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <input type="text" id="search" class="form-control" placeholder="Search by Faculty Name">
            </div>
            <div class="col-md-3 form-group align-self-end">
                <button id="search-btn" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Search</button>
            </div>
        </div>
        <div class="table-responsive mt-5" style="max-height: 470px; overflow-y: auto;">
            <table class="table table-bordered content-table" id="timetable-table" style="max-height: 400px; overflow-y: auto;">
                <thead>
                    <tr>
                        <th>Faculty Name</th>
                        <th>Day</th>
                        <th>8.00am - 8.50am</th>
                        <th>8.50am - 9.40am</th>
                        <th>9.40am - 10.30am</th>
                        <th>10.45am - 11.30am</th>
                        <th>12.05pm - 12.50pm</th>
                        <th>12.50pm - 1.35pm</th>
                        <th>1.45pm - 2.30pm</th>
                        <th>2.30pm - 3.15pm</th>
                    </tr>
                </thead>
  ...
  color: #007bff;
    ...
    <script>
        ...
        function loadTimetable() {
            $.get('fetchtimetable.php', function(data) {
                $('#timetable-table tbody').html(data);
            });
        }
    </script>
