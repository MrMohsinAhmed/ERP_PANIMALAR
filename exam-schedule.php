...
<head>
    ...
    <title>Panimalar ERP | Exam timetable</title>
 ...
 <!-- Sidebar Area End Here -->
            ...
            <label>Filter by Exam Type</label>
                ...
                <label>Filter by Semester</label>
                    <select name="filter_semester" class="select2 form-control">
                        ...
                        <button type="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Filter</button>
                        </div>
                        </div>
                        </form>
                            </div>
            ...
            <table class="table display data-table text-nowrap table-bordered">
                ...
                <tbody style="color:black;">
                    <?php
                    // Assuming $result contains the result set from the database query
