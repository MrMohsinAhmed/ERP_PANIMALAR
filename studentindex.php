...
<head>
    ...
    <title>Panimalar ERP | STUDENT Panel</title>
            ...
            <li class="navbar-item dropdown header-admin">
                <a class="navbar-nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                    ...
                    <div class="admin-title">
                        <h5 class="item-title">Mohsin Ahmed N</h5>
                        <span>Student</span>
                    </div>
                    <div class="admin-img">
                        <img src="img/Pi7_Passport_Photo.jpeg" width="40px" alt="Admin">
                    </div>
                </a>
                <div class="dropdown-menu dropdown-menu-right">
                    <div class="item-header">
                        <h6 class="item-title">Mohsin Ahmed N</h6>
                    </div>
                    <div class="item-content">
                        <ul class="settings-list">
                            <li><a href="student-details.html"><i class="flaticon-user"></i>My Profile</a></li>
                        ...
                        <div class="row">
                            <div class="col-6-xxxl col-lg-3 col-sm-6 col-12">
                                <div class="dashboard-summery-two">
                                    ...
                                    <div class="item-content">
                                        <div class="item-number"><span class="counter" data-num="8.1">8.1</span></div>
                                        <div class="item-title">CGPA</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6-xxxl col-lg-3 col-sm-6 col-12">
                                <div class="dashboard-summery-two">
                                    ...
                                    <div class="item-content">
                                        <div class="item-number"><span class="counter" data-num="94%">94%</span></div>
                                        <div class="item-title">Attendence</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6-xxxl col-lg-3 col-sm-6 col-12">
                                <div class="dashboard-summery-two">
                                    ...
                                    <div class="item-content">
                                        <div class="item-number"><span class="counter" data-num="25">25</span></div>
                            ...
                            <div class="col-6-xxxl col-lg-3 col-sm-6 col-12">
                                <div class="dashboard-summery-two">
                                    ...
                                    <div class="item-content">
                                        <div class="item-number"><span class="counter" data-num="14">14</div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="student-report">
                                    <div class="student-count pseudo-bg-blue">
                                        <h4 class="item-title">No. of day present</h4>
                                        <div class="item-number">87.3%</div>
                                    </div>
                                    <div class="student-count pseudo-bg-yellow">
                                        <h4 class="item-title">No. of days absent</h4>
                                        <div class="item-number">13.7%</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="notice-box-wrap">
                                    <div class="notice-list">
                                        <div class="post-date bg-skyblue">17 July, 2024</div>
                                        <h6 class="notice-title"><a href="#">Placement training for 2025 batch students is extended to 02 August, 2024 </a></h6>
                                        <div class="entry-meta">Placement Department / <span>5 min ago</span></div>
                                    </div>
                                    <div class="notice-list">
                                        <div class="post-date bg-yellow">06 July, 2024</div>
                                        <h6 class="notice-title"><a href="#">On 08th July 2024 college is reopening for II, III year students of PEC</a></h6>
                                        <div class="entry-meta">  ECE, HOD / <span>5 min ago</span></div>
                                    </div>
                                    <div class="notice-list">
                                        <div class="post-date bg-skyblue">17 July, 2024</div>
                                        <h6 class="notice-title"><a href="#">Placement training for 2025 batch students is extended to 02 August, 2024 </a></h6>
