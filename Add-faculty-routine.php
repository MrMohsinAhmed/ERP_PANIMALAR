...
<head>
    ...
    <title>Panimalar ERP | Faculty timetable</title>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="new-added-form" id="timetable-form" style="color: black;">
                    <div class="row">
            ...
            <label>Enter Subjects</label>
                <input type="text" class="form-control mb-2" placeholder="8.00am - 8.50am" id="time_1">
                <input type="text" class="form-control mb-2" placeholder="8.50am - 9.40am" id="time_2">
                <input type="text" class="form-control mb-2" placeholder="9.40am - 10.30am" id="time_3">
                <input type="text" class="form-control mb-2" placeholder="10.45am - 11.30am" id="time_4">
                <input type="text" class="form-control mb-2" placeholder="12.05pm - 12.50pm" id="time_5">
                <input type="text" class="form-control mb-2" placeholder="12.50pm - 1.35pm" id="time_6">
                <input type="text" class="form-control mb-2" placeholder="1.45pm - 2.30pm" id="time_7">
                <input type="text" class="form-control mb-2" placeholder="2.30pm - 3.15pm" id="time_8">
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#timetable-form').on('submit', function(e) {
                ...
                $.post('savetimetable.php', formData, function(response) {
                    // Show success alert
                    alert('Timetable inserted successfully');
                }).fail(function() {
                    alert('Error occurred while saving the timetable');
                });
            });
        });
    </script>
