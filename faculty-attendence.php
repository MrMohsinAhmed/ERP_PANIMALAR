...
<head>
    ...
    <title>Panimalar ERP | Faculty Attendence</title>
 ...
 <!-- Sidebar Area End Here -->
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    <h3>FACULTY ATTENDENCE</h3>
                    <ul>
                        <li>
                            <a href="hodindex.html">Home</a>
                        </li>
                        <li>Faculty attendence</li>
                    </ul>
                </div>
    ...
    <div class="row" style="color: black;">
        ...
        <div class="col-xl-3 col-lg-6 col-12 form-group" style="color: black; width: 220px;">
            ...
            <select class="select2 filter-input" id="sectionFilter" style="color: black; width: 220px;">
                ...
                <option value="B">Associate Professor</option>
                <option value="C">Assistant Professor</option>
