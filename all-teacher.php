...
<head>
    ...
    <title>Panimalar ERP | All Teachers</title>
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        <div class="heading-layout1">
                            <div class="item-title" style="text-align: center;"><br>
                                <h3 style="font-weight: bold; text-align: center;">FACULTIES OF DEPARTMENT OF ELECTRONICS AND COMMUNICATION ENGINEERING</h3><br>
                            </div>

                        </div>
                        <div class="table-responsive" style="color: black; max-height: 400px; overflow-y: auto;">
                            <table class="table display data-table table-bordered text-nowrap" id="data-table">
            <!-- Table Header -->
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td><a href='" . htmlspecialchars($row["scopus"]) . "' target='_blank'>Scopus Link</a></td>";
                        echo "<td><a href='" . htmlspecialchars($row["docs"]) . "' target='_blank'>Faculty Docs</a></td>";
                        echo "</tr>";
                    }
                } else {
