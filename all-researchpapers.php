...
<head>
    ...
    <title>Panimalar ERP | All Students</title>
...
<div class="sidebar-main sidebar-menu-one sidebar-expand-md sidebar-color">
 ...
 <!-- Sidebar Area End Here -->
            <div class="dashboard-content-one">
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-6" style="color: black;">
                                                    <div class="item-content" style="color: black;">
                                                        <div class="item-title" style="color: black;">Total Research papers</div>
                                                        <div class="item-number"><span class="counter" data-num="358">358</span></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="card height-auto">
                    ...
                    <div class="card-body"><br>
                        ...
                        <h3 style="color: black; font-weight: bold;">ALL RESEARCH PAPERS</h3>
                        <div class="col-3-xxxl col-xl-3 col-lg-3 col-12 form-group" style="color: black;"> 
                        <label for="yearFilter">YEAR</label>
        <select id="yearFilter" class="form-control" style="width: 300px; background-color: lightgrey;">
    ...
    <button id="searchButton" class="fw-btn-fill btn-gradient-yellow" style="width: 100px;">Search</button>
    </div>
        </div>
    <div class="card height-auto">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table display data-table text-nowrap table-bordered" id="papersTable">
