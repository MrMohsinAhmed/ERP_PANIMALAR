...
<head>
    ...
    <title>Panimalar ERP | Faculty Duties</title>
 ...
 <!-- Sidebar Area End Here -->
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    <h3>ALL FACULTY DUTIES</h3>
                    <ul>
                        <li>
                            <a href="hodindex.php">Home</a>
                        </li>
                        <li>Faculty duties</li>
                    </ul>
                </div>
    ...
    <h2 style="font-weight: bold;">ALL FACULTIES DUTIES</h2>
    <div class="form-group">
        <label for="filter_name">Faculty Name:</label>
        <input type="text" id="filter_name" placeholder="Enter the Faculty Name" class="form-control">
    </div>
    <div class="form-group">
    ...
    <table class="table display text-nowrap table-bordered" style="max-height: 400px; overflow-y: auto;" >
        <thead style="color: black; text-align: center; background-color: darkblue;" >
        ...
        <tbody id="duties_table" style="color: black; text-align: left;">
    ...
    $(document).ready(function() {
        // Show alert if status is success
        const urlParams = new URLSearchParams(window.location.search);
        if (urlParams.get('status') === 'success') {
            alert('Faculty duty inserted successfully');
        }
    });
    </script>
<script>
