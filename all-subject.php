...
<head>
    ...
    <title>Panimalar ERP | Curriculum</title>
                ...
                <div class="card-body">
                    <div class="heading-layout1">
                        <div class="item-title">
                            <h3 style="font-weight: bold;">ADD NEW CURRICULUM:</h3>
                        </div>
                       <div class="dropdown">
...
<!-- Form HTML -->
<form id="subjectForm" class="new-added-form" action="save_subject.php" method="POST">
    <div class="row">
        <div class="col-xl-3 col-lg-6 col-12 form-group" style="color: black;">
            <label for="subject_code">Subject Code</label>
            <input type="text" class="form-control" placeholder="Enter the Subject Code" id="subject_code" name="subject_code" required>
        </div>
        <div class="col-xl-3 col-lg-6 col-12 form-group" style="color: black;">
            <label for="subject_name">Subject Name</label>
            <input type="text" class="form-control" placeholder="Enter the Subject Name" id="subject_name" name="subject_name" required>
        </div>
        <div class="col-xl-3 col-lg-6 col-12 form-group" style="color: black;">
            <label for="subject_type">Subject Type</label>
            <select class="form-control select2" id="subject_type" name="subject_type" required>
                <option value="All" selected hidden>Select the Subject type</option>
        ...
        <div class="col-xl-3 col-lg-6 col-12 form-group" style="color: black;">
            ...
            <input type="text" class="form-control" id="subject_faculty" placeholder="Enter the Faculty Name" name="subject_faculty" required>
        </div>
        <div class="col-xl-3 col-lg-6 col-12 form-group" style="color: black;">
            <label for="subject_notes">Subject Notes (URL)</label>
            <input type="url" class="form-control" id="subject_notes" placeholder="Paste the notes URL here" name="subject_notes" required>
        </div>
        <div class="col-xl-3 col-lg-6 col-12 form-group" style="color: black;">
            <label for="semester_number">Semester Number</label>
            <select class="form-control select2" id="semester_number" name="semester_number" required>
                <option value="All" selected hidden>Select the Semester</option>
...
<script>
    $(document).ready(function() {
        $('#subjectForm').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#subjectForm')[0].reset(); // Reset the form fields
                },
                error: function() {
        ...
        <h3 STYLE="FONT-WEIGHT: BOLD;">ALL CURRICULUM:</h3>
        ...
        <form method="GET" action="">
            ...
            <div class="form-group">
                <select class="form-control select2" id="semester_number" name="semester_number" style="width: 300px;" onchange="this.form.submit()">
        ...
        <div class="table-responsive mt-5" style="max-height: 425px; overflow-y: auto;">
        <table class="table table-bordered content-table" style="max-height: 500px; overflow-y: auto;">
            <thead style="max-height: 500px; overflow-y: auto;">
                <tr>
                    <th>Subject Code</th>
                    <th>Subject Name</th>
                    <th>Subject Type</th>
            ...
            <tbody style="max-height: 500px; overflow-y: auto;">
                ...
                $semester_number = isset($_GET['semester_number']) ? $_GET['semester_number'] : '';

                $sql = "SELECT * FROM subjects";
                if ($semester_number != '') {
                    $sql .= " WHERE semester_number = $semester_number";
                }
