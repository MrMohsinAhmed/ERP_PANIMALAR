 ...
 <!-- Sidebar Area End Here -->
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    <h3>ALL PATENTS DATA</h3>
                    <ul>
                        <li>
                            <a href="hodindex.php">Home</a>
                        </li>
                        <li>All patent details</li>
                    </ul>
                </div>
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-6" style="color: black;">
                                                    <div class="item-content" style="color: black;">
                                                        <div class="item-title" style="color: black;">Total patents</div>
                ...
                <div class="card height-auto" style="color: black;">
                    <div class="card-body"><br>
                        
                        <h3 style="color: black; font-weight: bold;">ALL PATENTS DATA</h3>
                        <form method="get" class="mg-b-20">
                        <div class="col-3-xxxl col-xl-3 col-lg-3 col-12 form-group">
                        <label for="year_filter">Year</label>
                <select class="form-control" id="year_filter" placeholder="Enter the year" name="year_filter" style="background-color: lightgrey;">
           ...
           <br> <button type="submit" class="fw-btn-fill btn-gradient-yellow">Filter</button>
                                </div>
        </form>
                        
                        <div class="table-responsive" style="max-height: 400px; overflow-y: auto;">
                        <table class="table display data-table table-bordered text-nowrap">
                        <thead>
                                    <tr>
                                        <th>Patent Number</th>
                                        <th>Name</th>
